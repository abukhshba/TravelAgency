    ...
    <section class="home">
        ...
        <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide" style="background:url(images/22.jpg) no-repeat">
                    <div class="content">
                        <span>explore, discover, travel</span>
                ...
                <div class="swiper-slide slide" style="background:url(images/5.jpg) no-repeat">
                    <div class="content">
                        <span>explore, discover, travel</span>
                        <h3>make your tour worthwhile</h3>
                        <a href="package.php" class="btn">discover more</a>
                ...
                <div class="swiper-slide slide" style="background:url(images/66.jpg) no-repeat">
                    <div class="content">
                        <span>explore, discover, travel</span>
                        <h3>make your tour worthwhile</h3>
                        <a href="package.php" class="btn">discover more</a>
                ...
                <div class="swiper-slide slide" style="background:url(images/7.jpg) no-repeat">
                    <div class="content">
                        <span>explore, discover, travel</span>
                        <h3>make your tour worthwhile</h3>
                        <a href="package.php" class="btn">discover more</a>
